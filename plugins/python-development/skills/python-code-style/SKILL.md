...
[tool.ruff]
line-length = 120
target-version = "py311"  # Adjust based on your project's minimum Python version
...
10. **Target Python 3.10+** - For new projects, Python 3.11+ is recommended for modern language features
